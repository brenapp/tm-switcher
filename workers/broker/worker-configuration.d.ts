/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 63c127a36747ee1e6605a77c03407814)
// Runtime types generated with workerd@1.20250709.0 2025-07-11 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		TOKENS: KVNamespace;
		TM_SWITCHER_VEX_TM_CLIENT_ID: string;
		TM_SWITCHER_VEX_TM_CLIENT_SECRET: string;
		TM_SWITCHER_VEX_TM_EXPIRATION_DATE: string;
		VEXTM_BROKER_ANALYTICS: AnalyticsEngineDataset;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TM_SWITCHER_VEX_TM_CLIENT_ID" | "TM_SWITCHER_VEX_TM_CLIENT_SECRET" | "TM_SWITCHER_VEX_TM_EXPIRATION_DATE">> {}
}
